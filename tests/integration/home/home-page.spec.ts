...
describe('WP-07.6 Home integration boundaries', () => {
  ...
  it.each([
    ...
    expect(available.map((item) => item.href)).toEqual([`/${locale}`, `/${locale}/map`, `/${locale}/behaviours`, `/${locale}/context`, `/${locale}/presentations`, `/${locale}/evidence`, `/${locale}/methodology`, `/${locale}/about`])
